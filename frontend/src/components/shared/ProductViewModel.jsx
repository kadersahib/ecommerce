...
function ProductViewModel({open, setOpen , product , isAvailable}) {
  ...
  return (
    <>
      ...
      <DialogBackdrop className="fixed inset-0 backdrop-blur-sm bg-black/15 transition-opacity" />
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
                <DialogPanel
              transition
              className="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all md:max-w-[630px] md:min-w-[630px] w-full"
            >
                {image && (
